# Generated by Powerlevel10k configuration wizard on 2021-11-18 at 14:52 CST.
...
() {
  ...
  #   # Wifi colors and icons for different signal strength levels (low to high).
    typeset -g my_wifi_fg=(1 11 39 27 40)                                # <-- change these values
    typeset -g my_wifi_icon=('\ufaa9' '\ufaa8' '\ufaa8' '\uf1eb' '\uf1eb')     # <-- change these values
  #
